# -*- coding: utf-8 -*-
#Python class "Pandas TableView". Allows to conveniently interface with a pandas.DataFrame via PyQt5 view/model architecture. Copyright (C) 2023 Anna Anikina
#
